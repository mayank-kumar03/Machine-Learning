...
class NewPatient(BaseModel):
      ...
      gender: Annotated[
        Optional[Literal['male', 'female', 'neutral']],
        Field(default=None)
    ]
...
def update_patient(patient_id:str,patient_update:NewPatient):
     data=load_data()
...
def delete_patient(patient_id:str):
     ...
     del data[patient_id]
     save_data(data)
     return JSONResponse(status_code=201,content={'message':'patient data deleted successfully'})
